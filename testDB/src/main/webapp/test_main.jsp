	    ...
	    <div class="row">	        
	        <div class="col-sm-6">   
	        	<div class="input-group mb-3">
		      		<input type="text" name='txt_user_id' class="form-control" placeholder="ID 입력바람!" value='h' aria-label="Recipient's username" aria-describedby="button-addon2" onkeyup='javascript:searchData();'> <!--여기다가 searchData()추가하면 검색할 때마다 자동갱신 -->
